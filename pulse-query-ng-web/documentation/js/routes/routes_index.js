var ROUTES_INDEX = {
  ...
  children: [
    ...
    { name: 'admin/users', kind: 'route-path', filename: 'src/app/app.routes.ts' },
    ...
    { name: 'analytics/alert-rules', kind: 'route-path', filename: 'src/app/app.routes.ts' },
    { name: 'mpax-arena', kind: 'route-path', filename: 'src/app/app.routes.ts' },
    { name: 'benchmarks', kind: 'route-path', filename: 'src/app/app.routes.ts' },
