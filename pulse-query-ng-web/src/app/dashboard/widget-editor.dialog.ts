import { Component, computed, ChangeDetectionStrategy, Signal, inject, signal } from '@angular/core'; 
  ...
  saveSettings() {
    ...
    this.dashboardsApi.getDashboardApiV1DashboardsDashboardIdGet(this.data.dashboardId)
      .subscribe((dash: DashboardResponse) => {
        ...
        this.dashboardsApi.updateWidgetApiV1DashboardsWidgetsWidgetIdPut(this.widget.id, update)
          .subscribe(() => {
