 ...
 * - Manages the "Ask Data" right-side drawer visibility via {@link AskDataService}.
 * - Hosts the main routing outlet.
 */
...
@Component({
  selector: 'app-root',
  // 'standalone: true' is omitted as it is the default in this architecture.
  imports: [
    RouterOutlet, 
    MatSidenavModule, 
    AskDataComponent
