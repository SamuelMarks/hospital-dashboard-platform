...
export class BenchmarksService extends BaseService {
  constructor(
   ...
   * @endpoint get /api/v1/benchmarks/mpax
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   * @param options additional options
   */
  public getMpaxBenchmarksApiV1BenchmarksMpaxGet(
    observe?: 'body',
  ...
  public getMpaxBenchmarksApiV1BenchmarksMpaxGet(
    ...
    let localVarPath = `/api/v1/benchmarks/mpax`;
   ...
   * @endpoint get /api/v1/benchmarks/sql
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   * @param options additional options
   */
  public getSqlBenchmarksApiV1BenchmarksSqlGet(
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
      httpHeaderAccept?: 'application/json';
  ...
  public getSqlBenchmarksApiV1BenchmarksSqlGet(
    ...
    let localVarPath = `/api/v1/benchmarks/sql`;
    const { basePath, withCredentials } = this.configuration;
    return this.httpClient.request<Array<{ [key: string]: any }>>(
      'get',
      `${basePath}${localVarPath}`,
