...
$LIBSCRIPT_ROOT_DIR/libscript.sh provision azure vm-pulse-query rg-analytics-prod eastus ./ pulse-query

# Map the domain to the newly provisioned node
$LIBSCRIPT_ROOT_DIR/libscript.sh azure dns map-node vm-pulse-query rg-analytics-prod pulse-query.healthplatform.io healthplatform-zone
```
...
```bash
$LIBSCRIPT_ROOT_DIR/libscript.sh deprovision azure vm-pulse-query rg-analytics-prod eastus ./ pulse-query
```
...
```bash
$LIBSCRIPT_ROOT_DIR/libscript.sh azure node deploy shared-node rg-analytics-prod ./ pulse-query
```
...
```bash
# Map DNS
$LIBSCRIPT_ROOT_DIR/libscript.sh azure dns map-node shared-node rg-analytics-prod pulse-query.healthplatform.io healthplatform-zone

# Install dependencies and start the stack on the remote node
$LIBSCRIPT_ROOT_DIR/libscript.sh azure node exec shared-node rg-analytics-prod "cd pulse-query && sudo ~/libscript/libscript.sh install-deps"
$LIBSCRIPT_ROOT_DIR/libscript.sh azure node exec shared-node rg-analytics-prod "cd pulse-query && sudo ~/libscript/libscript.sh start"
```
...
```bash
# Unmap DNS
$LIBSCRIPT_ROOT_DIR/libscript.sh azure dns unmap-node shared-node rg-analytics-prod pulse-query.healthplatform.io healthplatform-zone
...
$LIBSCRIPT_ROOT_DIR/libscript.sh azure node deploy shared-node rg-analytics-prod ./ pulse-query-alpha

# Deploy Production version
$LIBSCRIPT_ROOT_DIR/libscript.sh azure node deploy shared-node rg-analytics-prod ./ pulse-query-prod
```
...
```bash
# Map Alpha DNS
$LIBSCRIPT_ROOT_DIR/libscript.sh azure dns map-node shared-node rg-analytics-prod alpha.pulse-query.healthplatform.io healthplatform-zone
...
```bash
$LIBSCRIPT_ROOT_DIR/libscript.sh azure node exec shared-node rg-analytics-prod "cd pulse-query-alpha && sudo ~/libscript/libscript.sh start"
$LIBSCRIPT_ROOT_DIR/libscript.sh azure node exec shared-node rg-analytics-prod "cd pulse-query-prod && sudo ~/libscript/libscript.sh start"
```
