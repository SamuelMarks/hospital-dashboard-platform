...
async def list_templates(
  ...
  category: Annotated[str | None, Query(description="Filter templates by category")] = None,
  search: Annotated[str | None, Query(description="Search title or description")] = None,
