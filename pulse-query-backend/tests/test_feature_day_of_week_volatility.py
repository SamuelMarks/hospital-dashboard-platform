...
def db_conn() -> duckdb.DuckDBPyConnection:
  ...
  for _ in range(5):
    conn.execute("INSERT INTO synthetic_hospital_data VALUES ('Volatile_Ward', '2023-01-01 23:59:00')")
  for _ in range(25):
    conn.execute("INSERT INTO synthetic_hospital_data VALUES ('Volatile_Ward', '2023-01-02 23:59:00')")
  for _ in range(5):
    conn.execute("INSERT INTO synthetic_hospital_data VALUES ('Volatile_Ward', '2023-01-03 23:59:00')")
