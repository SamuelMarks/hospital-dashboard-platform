...
def test_schema_string_generation() -> None:
  """
  Verifies that the schema string is generated and includes ingested tables.
  ...
  # 1. Check if the table created via dynamic ingest exists
  # The filename 'hospital_data.csv' -> 'hospital_data'
  assert "Table: hospital_data" in schema_str

  # 2. Check for some expected columns
